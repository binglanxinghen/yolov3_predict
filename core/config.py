...
__C.YOLO.ORIGINAL_WEIGHT        = "./checkpoint/yolov3_test_loss=14.3149.ckpt-30.ckpt"
...
#__C.TEST.WEIGHT_FILE            = "./checkpoint/yolov3_test_loss=12.5364.ckpt-50"
__C.TEST.WEIGHT_FILE            = "./checkpoint/yolov3_test_loss=4.4276.ckpt-208"
